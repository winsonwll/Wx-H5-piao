                            ...
                            setting: function(){
                                ...
                                function putShowPrice(data){
                                    ...
                                    for(var m=0,len=$arrTime.length;m<len;m++){
                                        ...
                                        html += '<div class="row">' +
                                            '<div class="col-33">票价</div>' +
                                            '<div class="col-33">同行价</div>' +
                                        ...
                                        for(var n=0,length=$arrPrice[m].length;n<length;n++){
                                            ...
                                            html += '<div class="row" data-showPriceId="'+$arrPrice[m][n].showPriceId+'">' +
                                                '<div class="col-33" data-parValueId="'+$arrPrice[m][n].showPriceId+'">'+$arrPrice[m][n].areaPrice+'</div>' +
                                                '<div class="col-33 selling-price"><input type="number" min="0" value="'+$perPrice+'"></div>' +
                                                '<div class="col-33">' +
                                        ...
                                        if(data.length>0){
                                            ...
                                            for(var i=0,len=data.length;i<len;i++){
                                                ...
                                                for(var j in data[i].myOders){
                                                    html += '<div class="row">' +
                                                        '<div class="col-30">'+data[i].myOders[j].areaName+'</div>' +
                                                        '<div class="col-30">'+data[i].myOders[j].perPrice+'</div>' +
                                                        '<div class="col-20">'+data[i].myOders[j].sellNum+'</div>' +
                                        ...
                                        if(data.length>0){
                                            ...
                                            for(var i=0,len=data.length;i<len;i++){
                                                popupHTML += '<div class="row">' +
                                                    '<div class="col-33" data-id="'+data[i].id+'">'+data[i].areaName+'</div>' +
                                                    '<div class="col-33 selling-price">' +
